...
<body>
  ...
  <div class="page-section">
    <div class="container">
      ...
      <form class="contact-form mt-5" action="{{url('massage')}}" method="post">
      	@csrf
        <div class="row mb-3">
          ...
          <div class="col-12 py-2 wow fadeInUp">
            ...
            <textarea id="message" name="massage" class="form-control" rows="8" placeholder="Enter Message.."></textarea>
          </div>
        </div>
